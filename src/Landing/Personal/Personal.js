    ...
    return (
        <div className="personal">
            <p className="personal__text">
                Имею высшее образование, неоконченную степень кандидата технических наук. Увлекаюсь программированием, психологией, педагогикой, музыкой (когда-то – играть, теперь – слушать). Люблю чай, пешие прогулки и общество умных людей. Ненавижу – все остальное.<br></br>
